loadstring(game:HttpGet('https://raw.githubusercontent.com/Egamerk/Better/main/Jan'))()
-- [Legit Tab UI] ------------------------------------------------------------------------------------------------------------------------------------------------------------
...
LegitMain:AddToggle{text = "Enabled", flag = "TriggerEnabled"}:AddBind({flag = "keybind",Enum.KeyCode.LeftAlt,function(key)
    print(key)
end})
LegitMain:AddToggle{text = "Fly"}:AddSlider{text = "Fly Speed", min = 0, max = 100, value = 0, suffix = "‎ "}
LegitMain:AddToggle{text = "Speed"}:AddSlider{text = "Speed", min = 0, max = 1068, value = 16, suffix = "‎ ", callback = function(y)
    wait()
    game:GetService("Workspace").Alive[game.Players.LocalPlayer.Name].Stats.WalkSpeed.Value = y
end}
LegitMain:AddButton({text = "Reset Speed", callback = function()
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(5769, 325, 632)
                a.Completed:Wait()
            end
...
LegitSecond:AddList({text = "Teleports", flag = "AimbotKey" , value = "Tundra 7" , value = "Tundra 6" , value = "Tundra 5",  value = "Tundra 3", value = "Tundra 2"  , value = "Tundra 1" ,  value = "Forest 7" , value = "Forest 6", value = "Forest 5" ,  value = "Forest 4" , value = "Forest 3" ,  value = "Forest 2"  , value = "Forest 1",  value = "Ores 3", value = "Ores 1", value = "Ores 2", value = "--", values = {"--", "Ores 1" ,"Ores 2" ,"Ores 3","Forest 1" , "Forest 2" , "Forest 3", "Forest 4", "Forest 5", "Forest 6", "Forest 7", "Tundra 1" , "Tundra 2" , "Tundra 3", "Tundra 5", "Tundra 6" , "Tundra 7"}, callback = function(mob)
    if mob == "Ores 1" then
        while mob == "Ores 1" do 
...
LegitSecond:AddToggle{text = "Enabled", flag = "AimbotEnabled" }
LegitSecond:AddSlider{text = "Aimbot FOV", flag = "AimbotFov", min = 0, max = 750, value = 105, suffix = "°"}
LegitSecond:AddList({text = "Aimbot Key", flag = "AimbotKey", value = "On Aim", values = {"On Aim", "On Shoot"}});
LegitSecond:AddDivider("Draw Fov");
LegitSecond:AddToggle{text = "Enabled", flag = "TriggerEnabled"}:AddBind({flag = "TriggerBind", key = "One"});
...
SettingSection:AddSlider({text = "Tile Size", min = 0, max = 100, value = 10, callback = function(speed)
